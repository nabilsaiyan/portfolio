...
export default function ProjectDetailModal({ projectKey, onClose }: Props) {
  ...
  useEffect(() => {
    const onChange = () => { if (!document.fullscreenElement) setFsActive(null) }
    document.addEventListener('fullscreenchange', onChange)
    return () => document.removeEventListener('fullscreenchange', onChange)
  }, [])

  const toggleFs = (ref: React.RefObject<HTMLDivElement>, id: string) => {
          ...
          >
            ...
            >
              ...
              <div className="pdm-body">
                ...
                >
                  {meta.demoDesktop && (
                    <div className="pdm-browser-frame" ref={browserRef}>
                      <div className="pdm-browser-chrome">
                        ...
                        <button
                          ...
                          onClick={() => toggleFs(browserRef, 'browser')}
                          title="Fullscreen"
                        >
                  ...
                  {meta.demoMobile && (
                    <div className="pdm-phone-frame" ref={phoneRef}>
                      <div className="pdm-phone-notch" />
                      <button
                        className="pdm-phone-fs-btn"
                        onClick={() => toggleFs(phoneRef, 'phone')}
                        title="Fullscreen"
                      >
